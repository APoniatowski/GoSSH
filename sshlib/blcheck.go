...
func (blstruct *ParsedBaseline) checkPrereq(serverslist []string) commandset []string {
	fmt.Println(servers)
...
func (blstruct *ParsedBaseline) checkMustHaves(servers []string) []string {
...
func (blstruct *ParsedBaseline) checkMustNotHaves(servers []string) []string {
	var commandset []string
	//MNH list
...
func (blstruct *ParsedBaseline) checkFinals(servers []string) []string {
	var commandset []string
	// Final steps list
