...
func (blstruct *ParsedBaseline) checkPrereq(servers *[]string, oslist *[]string) (commandset []string) {
	fmt.Println(servers)
...
func (blstruct *ParsedBaseline) checkFinals(servers *[]string, oslist *[]string) (commandset []string) {
	// Final steps list
